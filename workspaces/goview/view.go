// original source: https://github.com/foolin/goview/blob/master/view.go
...
type IViewEngine interface {
	...
	executeRender(out io.Writer, name string, data interface{}) error
	executeTemplate(out io.Writer, name string, data interface{}, useMaster bool) error
	SetFileHandler(handle FileHandler)
}
